    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 text-teal-400 mb-2">
          ...
          <span className="text-sm uppercase tracking-wider">Appendix</span>
        </div>
        ...
        <div className="mt-6 bg-teal-900/20 border border-teal-500/30 rounded-lg p-4">
          ...
          <ul className="text-sm text-gray-300 space-y-1">
            <li>- The Project Startup System concept</li>
            <li>- Set up the 5 core documentation files</li>
            <li>- Use trigger phrases for documentation and QA</li>
            <li>- Understand the 4 QA agents and the QA cycle</li>
            <li>- Manage sessions with /compact and /clear</li>
            <li>- Configure the documentation hierarchy</li>
          </ul>
        </div>
      </div>
